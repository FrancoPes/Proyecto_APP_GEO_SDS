...
campo_pais_var = 'Pais'
query_concat = "SELECT " + campo_idcliente_var +', '+ campo_domicilio_var +', '+ campo_localidad_var +', '+ campo_provincia_var +', '+ campo_pais_var + " from " + tabla_cliente_var + " c join " + tabla_localidad_var + " l on  (c." + campo_localidad_var + = l.id_localidad) join " + tabla_provincia_var + " pr on (pr.id_provincia = l.id_provincia) join " + tabla_pais_var + " pa on (pa.id_pais = pr.id_pais);"
